...
import { useTotalStatusPinjaman } from "@/app/api/laporan/totalStatusPinjaman/model"
import { PDFDownloadLink } from "@react-pdf/renderer"
import { StatusPinjaman } from "@/app/laporan/totalStatusPinjaman/page"
...
const LaporanSelect = () => {
  const { data: totalStatusPinjaman } = useTotalStatusPinjaman()
  return (
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="z-[1] bg-base-100 shadow p-2 rounded-box w-52 dropdown-content menu">
        <li>
          <PDFDownloadLink
            document={<StatusPinjaman data={totalStatusPinjaman} />}
            fileName="total-status-pinjaman.pdf"
          >
            Total Status Pinjaman
          </PDFDownloadLink>
        </li>
      </ul>
    </div>
