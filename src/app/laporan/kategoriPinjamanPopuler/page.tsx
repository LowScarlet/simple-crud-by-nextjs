...
import { KategoriPinjamanPopuler } from "@/app/api/laporan/kategoriPinjamanPopuler/model";
...
export const PinjamanPopuler = ({ data }: { data?: KategoriPinjamanPopuler[] }) => (
  <Document>
    <PDFPage size="A4" orientation="landscape" style={styles.page}>
      <Text style={styles.title}>Laporan Kategori Pinjaman Populer</Text>
