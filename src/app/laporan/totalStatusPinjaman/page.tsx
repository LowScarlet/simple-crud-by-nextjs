...
import { TotalStatusPinjaman } from "@/app/api/laporan/totalStatusPinjaman/model";
...
export const StatusPinjaman = ({ data }: { data?: TotalStatusPinjaman[] }) => (
  <Document>
    <PDFPage size="A4" orientation="landscape" style={styles.page}>
      <Text style={styles.title}>Laporan Total Status Pinjaman</Text>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          ...
          <View style={styles.tableCol}>
            <Text style={styles.tableCell}>Banyak Pinjaman</Text>
          </View>
        </View>
        {data?.map((item, index) => (
          <View style={styles.tableRow} key={index}>
            ...
            <View style={styles.tableCol}>
              <Text style={styles.tableCell}>{item._count.Pinjaman}</Text>
            </View>
          </View>
        ))}
      </View>
