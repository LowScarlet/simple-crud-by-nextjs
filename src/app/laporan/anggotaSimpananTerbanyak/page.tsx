...
import { AnggotaSimpananTerbanyak } from "@/app/api/laporan/anggotaSimpananTerbanyak/model";
...
export const SimpananTerbanyak = ({ data }: { data?: AnggotaSimpananTerbanyak[] }) => (
  <Document>
    <PDFPage size="A4" orientation="landscape" style={styles.page}>
      <Text style={styles.title}>Laporan Anggota Dengan Pinjaman terbanyak</Text>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          ...
          <View style={styles.tableCol}>
            <Text style={styles.tableCell}>Total Simpanan</Text>
          </View>
        </View>
        {data?.map((item, index) => (
          <View style={styles.tableRow} key={index}>
            ...
            <View style={styles.tableCol}>
              <Text style={styles.tableCell}>{item.totalSimpanan}</Text>
            </View>
          </View>
        ))}
      </View>
