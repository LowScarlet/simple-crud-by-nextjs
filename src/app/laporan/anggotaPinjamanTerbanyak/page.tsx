...
import { AnggotaPinjamanTerbanyak } from "@/app/api/laporan/anggotaPinjamanTerbanyak/model";
...
export const PinjamanTerbanyak = ({ data }: { data?: AnggotaPinjamanTerbanyak[] }) => (
  <Document>
    <PDFPage size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          ...
          <View style={styles.tableCol}>
            <Text style={styles.tableCell}>Total Pinjaman</Text>
          </View>
        </View>
        {data?.map((item, index) => (
          <View style={styles.tableRow} key={index}>
            ...
            <View style={styles.tableCol}>
              <Text style={styles.tableCell}>{item.totalPinjaman}</Text>
            </View>
          </View>
        ))}
      </View>
